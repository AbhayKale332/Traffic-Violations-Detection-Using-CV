...
export default function HelmetDetection() {
  ...
  const helmetCount =
    result?.predictions.filter((p) =>
      ...
      !p.class.toLowerCase().includes("no")
    ).length ?? 0;
  const noHelmetCount =
    result?.predictions.filter((p) =>
      p.class.toLowerCase().includes("no")
        ...
        {result && (
          <div className="w-full max-w-lg space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-lg border border-green-100 bg-green-50 px-4 py-3 flex items-center gap-3">
                <ShieldCheck className="h-5 w-5 text-green-600 shrink-0" />
                <div>
                  <p className="text-xs text-green-700 font-medium">With Helmet</p>
              ...
              <div className="rounded-lg border border-red-100 bg-red-50 px-4 py-3 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-red-700 font-medium">No Helmet</p>
